...
class Webhook {
    ...
    */
    constructor(url, resb, nowait = false) {
        this.url = url;
        this.id = "";
        this.token = "";
        this.meta = {};
    ...
    */
    sendPayload(payloadRaw, resolveFunction, res) {
    ...
    */
  image(name, message, title, imageUrl, res) {
        let payload = {
            "username": name,
            "attachments": [{
                "fields": [{
    ...
    return this.sendPayload(payload, res);
    }
    ...
    send(messageBuilder, res) {
        return new Promise((resolve, reject) => {
            ...
            if (
                ...
                return this.sendPayload(messageBuilder.data, resolve, res);
            } else if (
